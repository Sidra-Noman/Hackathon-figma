...
<footer className="bg-black text-white px-4 py-8 ">
  <div className="flex flex-col items-center md:flex-row md:space-x-8 md:items-start max-w-screen-xl mx-auto">
    {/* Column 1 */}
    ...
    <div className="flex justify-center md:justify-start items-center gap-4 md:ml-auto">
      ...
      <ImInstagram className="text-lg cursor-pointer hover:text-gray-400" />
    </div>
  </div>

  {/* Bottom Section */}
  <div className="flex flex-col md:flex-row justify-between items-center text-xs text-gray-400 mt-8 max-w-screen-xl mx-auto">
